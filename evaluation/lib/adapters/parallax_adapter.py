...
from evaluation.lib.adapters.registry import register_adapter
from evaluation.lib.core.data_models import Conversation, SearchResult
from utils.datetime_utils import to_iso_format

logger = logging.getLogger(__name__)

# 导入 Parallax 实现
from evaluation.lib.adapters.parallax import (
...
"""
    ...
    def _convert_config_to_experiment_config(self):
        ...
        """
        from evaluation.lib.adapters.parallax.config import ExperimentConfig
        import os
