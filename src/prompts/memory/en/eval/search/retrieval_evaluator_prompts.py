...
RETRIEVAL_EVALUATOR_PROMPT = """You are a meticulous and detail-oriented retrieval evaluator following the C-RAG (Corrective RAG) framework. Your task is to critically assess the quality of retrieved documents and classify them into three categories to determine the next retrieval action.
