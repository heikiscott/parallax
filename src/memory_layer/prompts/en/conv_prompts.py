...
- **Information sufficiency**: Set should_wait=true when there is insufficient information to make a confident boundary decision and more context is needed
...
{{
    ...
    "confidence": 0.0-1.0,
    "topic_summary": "If should_end = true, summarize the core meaningful topic of the current episode, and the language of the summary must be consistent with the language type of the input corpus; otherwise leave it blank}}
Note:
...
- should_wait=true indicates insufficient information to make a confident decision; wait for more context
"""
