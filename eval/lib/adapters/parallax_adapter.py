...
from eval.lib.adapters.registry import register_adapter
from eval.lib.core.data_models import Conversation, SearchResult
from utils.datetime_utils import to_iso_format

logger = logging.getLogger(__name__)

# 导入 Parallax 实现
from eval.lib.adapters.parallax import (
