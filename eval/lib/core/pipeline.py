...
from eval.lib.core.data_models import (
    Dataset, SearchResult, AnswerResult, EvaluationResult
)
from eval.lib.adapters.base import BaseAdapter
from eval.lib.evaluators.base import BaseEvaluator
from eval.lib.utils.logger import setup_logger, get_console
from eval.lib.utils.saver import ResultSaver
from eval.lib.utils.checkpoint import CheckpointManager

# 导入答案生成所需的组件
from providers.llm.llm_provider import LLMProvider

# 导入各个阶段的执行函数
from eval.lib.core.stages.add_stage import run_add_stage
from eval.lib.core.stages.search_stage import run_search_stage
from eval.lib.core.stages.answer_stage import run_answer_stage
from eval.lib.core.stages.evaluate_stage import run_evaluate_stage
